...
<p><img alt="" src="" style="float:left; height:156px; width:250px">In the left figure, we can see a weighted tree with 5 vertices. The tree median is {B} because the total cost from vertex B to all other vertices is minimal.</p>
